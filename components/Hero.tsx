  ...
  return (
    <div className="flex  justify-evenly   items-center ">
     <div className=" sm:p-4 sm:m-4 p-4 m-2 flex text-white glass rounded-2xl items-center sm:flex-row flex-col"> 
       ...
       <p className=" w-[300px] sm:w-[500px] h-30 text-[1em] sm:text-[1.3em]"> <span className="text-[1.1em]">"</span> Hi, Iam 'Sajan Nethsara' and Iam a web developer who is dedicated to continuously learning new things to become more professional..<span className="text-[1.1em]">"</span></p>    
